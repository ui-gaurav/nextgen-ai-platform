/**
 * 14 SVG Icon Components — Heroicons-style, currentColor-ready.
 *
 * TWO rendering patterns:
 *   Stroke icons (10): fill="none" stroke="currentColor" strokeWidth="1.5"
 *   Solid icons  (4):  fill="currentColor"
 *
 * All path `d` attributes are verbatim from the extracted asset pack.
 * Hardcoded fill="#000000" has been stripped — icons inherit currentColor.
 */

/* ───────────────────────────────────────────
 * STROKE ICONS (10) — outline style
...
/**
 * Cog-8-Tooth — gear outline + inner circle (2 paths, shared stroke styling)
 * Both paths share the same stroke treatment — wrapped in a single <svg>.
 */
export const Cog8ToothIcon = (props) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const Cube16SolidIcon = (props) => (
  <svg
    viewBox="0 0 16 16"
    fill="currentColor"
    className="w-4 h-4"
